...
namespace Mayhap.Maybe
{
    ...
    public static class MaybeFactory
    {
        ...
        public static Maybe<TValue> Fail<TValue>(this in Problem error)
        ...
        public static Maybe<TValue> Fail<TValue>(this string error)
            => new Maybe<TValue>(Problem.New().WithType(error).Create().Some(), Optional.None<TValue>());
        ...
        public static Maybe<TValue> Fail<TValue>(this Enum error)
            => new Maybe<TValue>(Problem.OfType(error).Create().Some(), Optional.None<TValue>());
        ...
        public static Maybe<TValue> Success<TValue>(this TValue data)
            => new Maybe<TValue>(Optional.None<Problem>(), data.Some());
    }
}